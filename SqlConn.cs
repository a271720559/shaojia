...
namespace OrderManage
{
    ...
    {
        //public static SqlConnection conn = new SqlConnection("data source=192.168.1.11;initial catalog=OrderManage;persist security info=False;user id=sa;password=sa;");
        //public static SqlConnection conn = new SqlConnection("data source=localhost;initial catalog=OrderManage;persist security info=False;user id=sa;password=sa;");
